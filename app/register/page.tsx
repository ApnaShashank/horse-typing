...
import { ArrowLeft, ArrowRight, Mail, Type, User, Lock } from 'lucide-react';
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="grid-box border-white/10 bg-zinc-950/80 p-10 md:p-14 relative overflow-hidden group">
          ...
          <div className="flex flex-col items-center mb-10">
            ...
            <h1 className="text-3xl font-black uppercase tracking-tighter text-on-surface mb-3">Initialize</h1>
            <div className="flex items-center gap-2 text-[9px] font-black uppercase tracking-[0.4em] text-primary/40 animate-pulse">
              ...
              Identity Provisioning Sequence
            </div>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            <div className="space-y-3">
              <label className="text-[10px] font-black text-on-surface-variant/40 uppercase tracking-[0.4em]">Assigned Alias (Name)</label>
          ...
          <div className="mt-12 pt-8 border-t border-white/5 flex flex-col items-center gap-6">
            <p className="text-[10px] font-black text-on-surface-variant/30 uppercase tracking-[0.3em]">
              Already Registered? <Link href="/login" className="text-primary hover:text-primary-dim transition-colors">SignIn sequence</Link>
            </p>
